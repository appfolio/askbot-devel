...
LARGE_SITE_MODE_SETTINGS = {
    ...
    'MIN_REP_TO_VOTE_DOWN': 0,
    'MIN_REP_TO_ANSWER_OWN_QUESTION': 0,
    'MIN_REP_TO_ACCEPT_OWN_ANSWER': 0,
    'MIN_REP_TO_FLAG_OFFENSIVE': 0,
    'MIN_REP_TO_LEAVE_COMMENTS': 0,
    'MIN_REP_TO_DELETE_OTHERS_COMMENTS': 0,
    'MIN_REP_TO_DELETE_OTHERS_POSTS': 0,
    'MIN_REP_TO_UPLOAD_FILES': 0,
    'MIN_REP_TO_RETAG_OTHERS_QUESTIONS': 0,
    'MIN_REP_TO_EDIT_WIKI': 0,
    'MIN_REP_TO_EDIT_OTHERS_POSTS': 0,
    'MIN_REP_TO_VIEW_OFFENSIVE_FLAGS': 0,
    'MIN_REP_TO_CLOSE_OTHERS_QUESTIONS': 0,
    'MIN_REP_TO_HAVE_STRONG_URL': 0,
    #badge settings
    ...
    'MIN_FLAGS_TO_HIDE_POST': 10000,
    'MIN_FLAGS_TO_DELETE_POST': 10000,
}
